...
export default function Experience() {
    ...
    return (
        <section className='fixed inset-0 w-full h-full items-center justify-center z-50'>
            <form className='flex flex-col absolute top-20 left-[14%] w-3/4 min-h-[400px] bg-white shadow-2xl rounded-md p-4'>
                ...
                <textarea
                    ...
                    className='p-2 outline-none font-sans border border-[#202F5]'
                    onChange={handleChange}
                    value={description}
                    required
                ></textarea>
